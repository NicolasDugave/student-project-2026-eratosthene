...
<div id="leb-1873" class="article-historique w-11/12 max-w-6xl mx-auto hidden pb-16 pt-10">
  ...
  <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
    <div class="text-xl md:text-2xl font-medium leading-relaxed text-zinc-500 space-y-8 md:w-1/2">
      <p>
    ...
    <div class="mt-12 md:mt-0 md:w-1/2">
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Les premières voitures en 1873, Collection tl<sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">34</sup></p>
    </div>
  </div>
</div>
...
<div id="ficelle-1877" class="article-historique w-11/12 max-w-6xl mx-auto hidden pb-16 pt-10">
  ...
  <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
    ...
    <div class="mt-12 md:mt-0 md:w-1/2">
      <img src="static/img/ficelle-1877.jpg" class="w-full h-auto rounded-lg shadow-xl border border-zinc-200" alt="La Ficelle" />
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Vue du funiculaire Lausanne-Ouchy non datée, Collection Martine Desarzens</p>
    </div>
  </div>
</div>
...
<div id="tramways-1896" class="article-historique w-11/12 max-w-6xl mx-auto hidden pb-16 pt-10">
  ...
  <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
    ...
    <div class="mt-12 md:mt-0 md:w-1/2">
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Plan du réseau (1959)</p>
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Premier tramway (1895)<sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">36</sup></p>
    </div>
  </div>
</div>
...
<div id="signal-1899" class="article-historique w-11/12 max-w-6xl mx-auto hidden pb-16 pt-10">
  ...
  <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
    ...
    <div class="mt-12 md:mt-0 md:w-1/2">
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Affiche publicitaire du Signal de Sauvabelin vers 1900, Musée historique de Lausanne<sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">37</sup></p>
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Vue du funiculaire Lausanne-Signal vers 1940, Collection Martine Desarzens<sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">33</sup></p>
    </div>
  </div>
</div>
...
<div id="bus-1920" class="article-historique w-11/12 max-w-6xl mx-auto hidden pb-16 pt-10">
  ...
  <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
    ...
    <div class="mt-12 md:mt-0 md:w-1/2">
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Place de la Palud, entre 1916 et 1928, Collection Martine Desarzens au Musée Historique de Lausanne<sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">33</sup> </p>
    </div>
  </div>
</div>
...
<div id="expo-1964" class="article-historique w-11/12 max-w-6xl mx-auto hidden pb-16 pt-10">
  ...
  <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
    ...
    <img src="static/img/meso-1964.jfif" class="w-full h-auto rounded-lg shadow-xl border border-zinc-200" alt="Le Mésoscaphe “Auguste Piccard” inauguré à l’Expo 64" />
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Le Mésoscaphe “Auguste Piccard” lors de l’Expo 64<sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">44</sup></p>
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Le giratoire de la Maladière lors de l’Expo 64<sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">45</sup></p>
    </div>
  </div>
</div>
...
<div id="m1-1991" class="article-historique w-11/12 max-w-6xl mx-auto hidden pb-16 pt-10">
  ...
  <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
    ...
    <img src="static/img/epfl-1991.jpg" class="w-full h-auto rounded-lg shadow-xl border border-zinc-200" alt="Conception EPFL et plan m1" />
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Conception de couleur du projet EPFL (1976) <sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">43</sup></p>
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Plan du m1<sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">13</sup></p>
    </div>
  </div>
</div>
...
<div id="m2-2008" class="article-historique w-11/12 max-w-6xl mx-auto hidden pb-16 pt-10">
  ...
  <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
    ...
    <div class="mt-12 md:mt-0 md:w-1/2">
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Plan de la ligne du m2<sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">2</sup></p>
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Sstation Lausanne-Gare<sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">2</sup></p>
    </div>
  </div>
</div>
...
<div id="bus-ouest-2019" class="article-historique w-11/12 max-w-6xl mx-auto hidden pb-16 pt-10">
  ...
  <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
    ...
    <div class="mt-12 md:mt-0 md:w-1/2">
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Photographie d’un bus de la ligne 31, 2026</p>
    </div>
  </div>
</div>
...
<div id="vennes-2025" class="article-historique w-11/12 max-w-6xl mx-auto hidden pb-16 pt-10">
  ...
  <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
    ...
    <div class="mt-12 md:mt-0 md:w-1/2">
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Vues du Biopôle<sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">40</sup> </p>
      ...
      <p class="text-sm md:text-base text-zinc-500 mt-3 text-right italic">Vues de l’éco-quartier des Fiches Nord<sup class="text-sm md:text-base text-red-600 font-bold ml-0.5">41</sup></p>
    </div>
  </div>
</div>
...
<div class="w-[100vw] relative left-1/4">
  <div class="w-full md:w-11/12 mx-auto py-20 text-zinc-500">
    <h2 class="text-4xl md:text-5xl font-black italic mb-10 text-zinc-900">Analyse des dynamiques de fréquentation et perspectives de développement</h2>
    <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
        <div class="text-xl md:text-2xl font-medium leading-relaxed text-zinc-500 space-y-8 md:w-1/2">
        <p>
